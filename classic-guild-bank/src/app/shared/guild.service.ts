...
export class GuildService {
    ...
    public updateItemNotes(guildId: string, itemId: number, itemNotes: string) {
        return this.http.patch(this.serviceUri + `/UpdateItemNotes/${guildId}`, { itemId: itemId, notes: itemNotes });
    }
}
